                                ...
                                <div class="card-body">
                                    <form action="{{ route('admin_organiser_update' , $organiser->id) }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div><img src="{{ asset('uploads/'.$organiser->photo) }}" alt="" class="w_100"></div>
                                        </div>
                                        <div class="mb-4">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea name="biography" class="form-control h_200" cols="30" rows="10">{{ $organiser->biography }}</textarea>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-4">
