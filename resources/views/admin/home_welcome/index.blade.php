                                ...
                                <div class="card-body">
                                    <form action="{{ route('admin_home_welcome_update') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div><img src="{{ asset('uploads/'. $home_welcome->photo) }}" alt="" class="w_200"></div>
                                        </div>
                                        <div class="mb-4">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea name="description" class="form-control h_200" cols="30" rows="10">{{ $home_welcome->description }}</textarea>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-4">
