         ...
         <div class="main-content">
            <section class="section">
                <div class="section-header">
                    <h1>Assign Schedule to Speakers</h1>
                </div>
                                        ...
                                        <table id="example1" class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    @php
                                                        $day = DB::table('schedule_days')->where('id',$row->schedule_id1)->first();
                                                        echo $day->day;
                                                    @endphp
                                                     </td>
                                                    <td>
                                                        <a href="{{ route('admin_speaker_schedule_delete', $row->id) }}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fas fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
